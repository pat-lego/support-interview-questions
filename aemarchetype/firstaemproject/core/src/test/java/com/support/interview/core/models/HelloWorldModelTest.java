 ...
 */
package com.support.interview.core.models;
...
import com.support.interview.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "firstaemproject/components/helloworld");
